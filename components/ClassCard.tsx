...
import { ClassForm, ModuleForm, ArticleForm, VideoForm, QuizForm, FlashcardSetForm } from "../interfaces";
...
export default function ClassCard({
  ...
  return (
    ...
    <div id={`${class1["id"]}classDiv`} className="relative bg-green-50 rounded-lg p-8 mt-8">
