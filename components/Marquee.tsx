...
export default function SponsorsMarquee() {
    return (
        <div className="relative w-[100vw]">
            <p className="z-10 text-center font-montserrat text-[16px] font-bold leading-[150%] text-[#6B7280] mt-[20px]" data-aos="fade-up">Trusted By Students At The <span className="text-[#0E793C]">Top Universities</span></p>
