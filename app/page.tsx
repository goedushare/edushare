    ...
    <div className="h-full">
      <div className="text-center flex justify-center items-center h-full w-full px-[96px]">
        <div className=" h-[100vh] w-[60%] flex flex-col justify-center items-start">
          ...
          <Button className="bg-[#0E793C] text-white font-raleway font-bold" as={Link} href="/learn">
            Get Started
          </Button>
          <Chatbot />
        </div>
      ...
      <div className="text-center flex flex-col justify-start items-center h-full w-full px-[96px]">
        ...
        <div className="grid grid-rows-1 grid-flow-col justify-center items-center gap-x-[24px] mt-[20px]">
          <div className="rounded-md shadow-[#EEEEEE] shadow-md w-[300px] h-[400px] flex flex-col justify-center items-center px-[12px]">
            ...
            <p className="font-raleway text-[16px] pt-[8px] text-[#6B7280]">Connect with students from all over by sharing and accessing study materials. Learn more efficiently through collaboration.</p>
          </div>
          <div className="rounded-md shadow-[#EEEEEE] shadow-md w-[300px] h-[400px] flex flex-col justify-center items-center px-[12px]">
            ...
            <p className="font-raleway text-[16px] pt-[8px] text-[#6B7280]">Easily upload your notes, flashcards, and other study resources to help others while benefiting from materials shared by your peers.</p>
          </div>
          <div className="rounded-md shadow-[#EEEEEE] shadow-md w-[300px] h-[400px] flex flex-col justify-center items-center px-[12px]">
            ...
            <p className="font-raleway text-[16px] pt-[8px] text-[#6B7280]">Browse through a wide variety of student-contributed content to find new ways to approach your studies and deepen your understanding.</p>
          </div>
          <div className="rounded-md shadow-[#EEEEEE] shadow-md w-[300px] h-[400px] flex flex-col justify-center items-center px-[12px]">
            ...
            <p className="font-raleway text-[16px] pt-[8px] text-[#6B7280]">Engage with diverse learning materials and collaborate in real-time with your peers, making studying more dynamic and effective.</p>
          </div>
      ...
      <div className="text-center flex flex-row justify-center items-center h-full w-full px-[96px]">
        <div className="h-full w-[60%] flex flex-col justify-center items-start">
          ...
          <div className="grid grid-rows-3 grid-flow-col justify-start items-start gap-x-[24px] gap-y-[16px] mt-[20px] w-full">
            ...
            <div><p className="flex flex-row justify-start font-raleway text-[#6B7280] text-[16px]">Login or Register for an account on our platform</p></div>
            <div><p className="flex flex-row justify-start font-raleway text-[#6B7280] text-[16px]">Select a module to start learning</p></div>
            <div><p className="flex flex-row justify-start font-raleway text-[#6B7280] text-[16px]">Watch the video, read the article, and test your knowledge on the quiz</p></div>
          </div>

          <Button className="bg-[#0E793C] text-white font-raleway font-bold mt-[20px]" as={Link} href="/login">
            Register/Login
          </Button>
