...
export default function Sidebar() {
    return (
        ...
        <Accordion selectionMode="multiple" className="p-0 flex flex-col w-full">
            <AccordionItem key="1" aria-label="Module 1: How a Bill Becomes a Law" title="Module 1: How a Bill Becomes a Law" className="px-6 py-2 ">
            ...
            <AccordionItem key="3" aria-label="Module 3: The World of Campaign Finance" title="Module 3: The World of Campaign Finance" className="px-6 py-2 ">
                <div className="flex flex-col">
                    <div className="flex flex-row items-center py-4 pl-8 w-full border-b-1">
                    <img src={video.src} className="w-6 h-6"></img>
                    <p className="ml-4 leading-5 text-sm text-[#3E8914]">How a Bill Becomes a Law</p>
